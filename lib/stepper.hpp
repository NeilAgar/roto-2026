...
public:
    ...
    TRANSLATION_BUG_INLINE void pio_init(uint dir_pin, uint step_pin, float clock_divider) {
        stepper_program_init(pio_, sm_, pio_offset_[PIO_NUM(pio_)], dir_pin, step_pin, clock_divider);
    }
